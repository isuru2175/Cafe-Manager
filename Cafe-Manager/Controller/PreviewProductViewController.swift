...
print(self.category)
  ...
  func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell{
            ...
            cell.Name.text = self.foods[indexPath.row].foodName
...
//              }
    //        cell.FoodItemImage.image = UIImage(named: foodItems[2])
            ...
            cell.descriptions.text = self.foods[indexPath.row].discription
            cell.discount.text = ( "" + String(self.foods[indexPath.row].discount))
